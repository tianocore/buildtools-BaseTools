...
#
    ...
    if opt.INFFILE:
        if opt.DSCFILE:
            ...
            StatusCode = Process(ModuleFile, PlatformFile, ewb, opt.TARGET, opt.TOOL_CHAIN_TAG, opt.TARGET_ARCH, args)
        else:
        ...
        StatusCode = Process(None, PlatformFile, ewb, opt.TARGET, opt.TOOL_CHAIN_TAG, opt.TARGET_ARCH, args)
    else:
